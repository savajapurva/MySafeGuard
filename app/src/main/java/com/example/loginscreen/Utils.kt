...
import com.example.loginscreen.Reminder
import com.example.loginscreen.SafezoneActivity
...
fun sendNotification(context: Context, message: String, latLng: LatLng) {
  ...
  val intent = SafezoneActivity.newIntent(context.applicationContext, latLng)

  val stackBuilder = TaskStackBuilder.create(context)
      .addParentStack(SafezoneActivity::class.java)
