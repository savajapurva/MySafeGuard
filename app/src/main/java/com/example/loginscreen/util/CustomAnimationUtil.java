...
public class CustomAnimationUtil {
    ...
    public static void slideInFromLeft(Context context, View view) {
        run(context, view, R.anim.slide_from_left);
    }
    ...
    public static void slideOutToLeft(Context context, View view) {
        run(context, view, R.anim.slide_to_left);
    }
    ...
    public static void slideInFromRight(Context context, View view) {
        run(context, view, R.anim.slide_from_right);
    }
    ...
    public static void slideOutToRight(Context context, View view) {
        run(context, view, R.anim.slide_to_right);
    }
     ...
     * @param animationId
     */
    private static void run(Context context, View view, int animationId) {
