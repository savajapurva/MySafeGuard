...
import com.example.loginscreen.showReminderInMap
...
import kotlinx.android.synthetic.main.activity_main_safezone.*


class SafezoneActivity : BaseActivity(), OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
  ...
  companion object {
    ...
    fun newIntent(context: Context, latLng: LatLng): Intent {
      val intent = Intent(context, SafezoneActivity::class.java)
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    setContentView(R.layout.activity_main_safezone)
...
//      currentLocation.visibility = View.VISIBLE
  ...
  private fun showReminders() {
    map?.run {
      ...
      for (reminder in getRepository().getAll()) {
        showReminderInMap(this@SafezoneActivity, this, reminder)
      }
    }
  }
  ...
  override fun onMapReady(googleMap: GoogleMap) {
    ...
    map?.run {
      ...
      setOnMarkerClickListener(this@SafezoneActivity)
    }
